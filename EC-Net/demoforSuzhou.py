...
def main(num):
    ...
    src_points = np.load('demo/Suzhou/'+num+'Vscaled_spa0015_BeforeRigid.npy')
    ref_points = np.load('demo/Suzhou/'+num+'CTscaled_spa0015.npy')
    ...
    output_folder = "Results/val-Suzhou/"
...
if __name__ == "__main__":
    ...
    nums = [f"{i:02}" for i in range(1, 31)]
