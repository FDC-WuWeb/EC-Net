...
def main(num):
    ...
    src_points = np.load('demo/Fudan/'+num+'Vscaled_spa0015_BeforeRigid.npy')  #09
    ref_points = np.load('demo/Fudan/'+num+'CTscaled_spa0015.npy')
    ...
    transform = np.load('demo/Fudan/transform_'+num+'.npy')
    data_dict["transform"] = transform.astype(np.float32)
